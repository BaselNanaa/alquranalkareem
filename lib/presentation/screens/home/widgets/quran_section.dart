  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          Obx(() {
            final lastReadPage = quranCtrl.state.currentPage.value;
            final surah = QuranCtrl.instance.getCurrentSurahByPageNumber(
              lastReadPage,
            );
                        ...
                        Row(
                          children: [
                            ...
                            ButtomWithLine(
                              ...
                              onTap: () async {
                                await AudioCtrl.instance.state.audioPlayer
                                    .stop();
                                Get.to(
                                  () => AudioScreen(),
                                  transition: Transition.downToUp,
